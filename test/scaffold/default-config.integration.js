  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.okcash/data',
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.okcash/okcore-node.json');
    ...
    info.path.should.equal(home + '/.okcash');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.okcash/data');
