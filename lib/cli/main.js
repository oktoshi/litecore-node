...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `okcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ okcore-node add wallet-service');
      console.log('    $ okcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ okcore-node remove wallet-service');
      console.log('    $ okcore-node remove insight-api');
      console.log();
    });
