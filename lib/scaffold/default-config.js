...
/**
 * Will return the path and default okcore-node configuration. It will search for the
 * configuration file in the "~/.okcore" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.okcash');
  var defaultConfigFile = path.resolve(defaultPath, './okcore-node.json');
