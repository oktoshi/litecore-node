...
/**
 * Will return the path and okcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'okcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'okcore-node.json'))
  };
}
